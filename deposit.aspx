<%@ Page Language="C#" AutoEventWireup="true" CodeFile="deposit.aspx.cs" Inherits="ATM_Machine.client_deposit" %>
...
<body>
    <div class="submit-area">
        <form id="d_form" runat="server">
            ...
            <br /><br />
            <asp:Button ID="d_button" CssClass="deposit-button" runat="server" Text="Deposit" OnClick="Deposit_Button_Click"/>
        </form>
    </div>
