...
<div class="navbar" id="navbar">
    <span class="close-button" id="closeButton">Close</span> 
     <asp:Button ID="Home" runat="server" Text="Home" CssClass="Navbaropt" OnClick="Home_Click" CausesValidation="false" />
            <asp:Button ID="ViewAccountInfo" runat="server" Text="View Account Info" CssClass="Navbaropt" OnClick="ViewAccountInfo_Click" CausesValidation="false" />
            <asp:Button ID="Withdraw" runat="server" Text="Withdraw" CssClass="Navbaropt" OnClick="Withdraw_Click" CausesValidation="false"/>
            <asp:Button ID="Deposit" runat="server" Text="Deposit" CssClass="Navbaropt" OnClick="Deposit_Click" CausesValidation="false"/>
            <asp:Button ID="Transfer" runat="server" Text="Transfer" CssClass="Navbaropt" OnClick="Transfer_Click" CausesValidation="false" />
    <a href="login.aspx" class="Navbarlogout">Logout</a>
</div>
        <h1>User Details<asp:Label ID="Label1" runat="server" Text=""></asp:Label>
        </h1>
        <div class="container">
